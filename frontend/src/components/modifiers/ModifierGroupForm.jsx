...
const ModifierGroupForm = ({ group, onSubmit, onClose }) => {
    ...
    setFormData((prev) => ({
      ...
      modifiers: prev.modifiers.map((mod) =>
        mod.tempId === tempId
          ? {
              ...mod,
              [field]: field === "isDefault" || field === "isActive" ? value : value,
            }
  ...
  const validateForm = () => {
    // Validate group
    const { isValid: groupValid, errors: groupErrors } = validateModifierGroupData(formData);
        ...
        <div className="flex-1 overflow-y-auto p-6">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                />
                {errors.minSelect && (
                  <p className="text-red-600 text-sm mt-1">{errors.minSelect}</p>
                )}
              </div>
              ...
              <div>
                ...
                />
                {errors.maxSelect && (
                  <p className="text-red-600 text-sm mt-1">{errors.maxSelect}</p>
                )}
              </div>
            </div>
          </div>
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between border-b pb-2">
              <h3 className="font-semibold text-gray-700">Danh sách Options</h3>
              <button
                type="button"
                ...
                {formData.modifiers.map((mod, index) => (
                  <div
                    ...
                    className={`p-4 rounded-lg border ${
                      mod.isDefault ? "border-purple-300 bg-purple-50" : "border-gray-200 bg-white"
                    }`}
                  >
                      ...
                      <div className="flex-1 grid grid-cols-12 gap-3">
                        ...
                        <div className="col-span-5">
                          <input
                            ...
                            value={mod.name}
                            onChange={(e) =>
                              handleModifierChange(mod.tempId, "name", e.target.value)
                            }
                        ...
                        <div className="col-span-3">
                          <input
                            ...
                            value={mod.price}
                            onChange={(e) =>
                              handleModifierChange(mod.tempId, "price", e.target.value)
                            }
                        ...
                        <div className="col-span-2 flex items-center gap-2">
                          <input
                            ...
                            onChange={(e) =>
                              handleModifierChange(mod.tempId, "isActive", e.target.checked)
                            }
          ...
          <div className="flex gap-4 pt-4 border-t border-gray-200">
            ...
            >
              {isSubmitting ? "Đang lưu..." : group ? "Cập nhật" : "Tạo mới"}
            </button>
          </div>
        </form>
      </div>
