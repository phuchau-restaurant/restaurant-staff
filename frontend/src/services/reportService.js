...
const MOCK_BEST_SELLERS = [
  {
    ...
    imgUrl: "https://images.unsplash.com/photo-1541095058489-41bc8be27525?auto=format&fit=crop&q=80&w=200",
  },
  {
    dishId: "2",
    ...
    imgUrl: "https://images.unsplash.com/photo-1599599810769-bcde5a160d32?auto=format&fit=crop&q=80&w=200",
  },
  {
    dishId: "3",
    ...
    imgUrl: "https://images.unsplash.com/photo-1594834749740-74b3f6764be4?auto=format&fit=crop&q=80&w=200",
  },
  {
    dishId: "4",
    ...
    imgUrl: "https://images.unsplash.com/photo-1548599426-b8e7343e5900?auto=format&fit=crop&q=80&w=200",
  },
  {
    dishId: "5",
    ...
    imgUrl: "https://images.unsplash.com/photo-1525610819717-b64952044321?auto=format&fit=crop&q=80&w=200",
  },
];
...
export const fetchDashboardSummary = async () => {
  if (USE_MOCK_DATA) return new Promise((resolve) => setTimeout(() => resolve(MOCK_SUMMARY), 500));
  try {
...
export const fetchRevenueByPeriod = async (period = "week") => {
  if (USE_MOCK_DATA) return new Promise((resolve) => setTimeout(() => resolve(generateRevenueMock(period)), 600));
  try {
...
export const fetchBestSellers = async (limit = 5) => {
  if (USE_MOCK_DATA) return new Promise((resolve) => setTimeout(() => resolve(MOCK_BEST_SELLERS.slice(0, limit)), 700));
  try {
...
export const fetchPeakHours = async () => {
  if (USE_MOCK_DATA) return new Promise((resolve) => setTimeout(() => resolve(MOCK_PEAK_HOURS), 800));
  try {
    const response = await fetch(`${BASE_URL}/peak-hours`, { headers: HEADERS });
    const result = await response.json();
    if (result.success) return result.data;
    throw new Error(result.message);
  } catch (error) {
